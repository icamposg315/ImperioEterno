...
<body class="cuerpo">
    ...
    <section class="menuprincipal">
        <div>
            ...
            <div id="tienda">
                <a href="https://www.bubok.es/libros/267125/Un-imperio-eterno-Un-viaje-a-las-sombras" target="_blank"><i class="fa-solid fa-cart-shopping"></i></a>
            </div>
            ...
            <div class="contenido2">
                <nav id="menu">
                    <ul>
                        ...
                        <button>
                            <li>
                                <a class="flex7" id="log" href="../Un Imperio Eterno/login.html" target="_blank">
                                    <h2>LOG</h2>
                                </a>
                            </li>
                        </button>
    ...
    <main>
        ...
        <section class="formulario" id="contacto">
            ...
            <form method="" action="">
                <label>Nombre
                    <input class="control" placeholder="Nombre" type="text" name="" id="nombre">
                </label>
                <br>
                <label>Apellidos
                    <input class="control" placeholder="Apellido" type="text" name="" id="apellidos">
                </label>
                <br>
                <label>Email
                    <input class="control" placeholder="Email" type="email" name="" id="email">
                </label>
                <br>
                </label>
                <br>
                <label>¿Donde has conocido el libro?
                    <select class="control" nombre="" id="poke">
                ...
                <br>
                <br>
                <label>¿Que te ha parecido la idea del autor?.
                    <br>
                    <textarea class="control" placeholder="Pon un comentario. Max 500 palabras." rows="10" cols="60" name="" id="comentario"></textarea>
                </label>
                <br>
                <label>
                    <input class="control" type="checkbox" name="" id="">Acepto condiciones
                </label>
                <br>
                <button class="boton" id="enviar" type="submit">enviar</button>
                <br>
                <a href="../Un Imperio Eterno/miembro.html" target="_blank">
    ...
    <footer class="pie"><i class="fa-solid fa-copyright"></i>
        <p>COPYRIGHT</p>
        <a href="#menu" class="final">HOME</a>
    </footer>
